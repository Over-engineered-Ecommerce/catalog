...
public class ExceptionControllerHandler {
    ...
    private ResponseEntity<Map<String, String>> handleBadRequestExceptions(Exception e) {
        return ResponseEntity.badRequest().body(buildErrorResponse(e));
    }

    @ExceptionHandler({NoHandlerFoundException.class, NotFound.class})
    private ResponseEntity<Map<String, String>> handleNotFoundExceptions(Exception e) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(buildErrorResponse(e));
    }

    @ExceptionHandler(UniqueInsertConstraint.class)
    private ResponseEntity<Map<String, String>> handleConflictExceptions(Exception e) {
        return ResponseEntity.status(HttpStatus.CONFLICT).body(buildErrorResponse(e));
    }

    @ExceptionHandler(InternalError.class)
    private ResponseEntity<Map<String, String>> handleInternalServerError(Exception e) {
